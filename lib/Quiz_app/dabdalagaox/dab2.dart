...
class Dabdala2 extends StatefulWidget {
  const Dabdala2({Key? key}) : super(key: key);

  @override
  State<Dabdala2> createState() => _DabdalaState();
}
...
class _DabdalaState extends State<Dabdala2> {
  @override
        ...
        body: Container(
          ...
          child: Column(
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          QuestionModel.questions2[currentQuestionIndex].quistion,
                          style: TextStyle(
              ...
              AnswersWidget(questionModel: QuestionModel.questions2[currentQuestionIndex], onAnswerSelected: (isTure){UserResult[currentQuestionIndex] = isTure;},),
